...
function ensure_site_schema($pdo) {
    ...
    if (intval($admin_check) === 0) {
        ...
        $pdo->exec("INSERT INTO accounts (username, normalized_name, email, password_hash, is_admin, staff_role, is_verified, created_at) VALUES ('admin', 'admin', 'admin@local', '$admin_pass', 1, 'admin', 1, NOW())");
    }
