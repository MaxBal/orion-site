...
function verify_recaptcha($response) {
    // Ключи не настроены (вычищены из конфига, но в окружении не заданы) —
    // виджета на странице нет, проверять нечего. Пропускаем осознанно, иначе
    // логин и регистрация станут недоступны вообще.
    if (defined('RECAPTCHA_ENABLED') && !RECAPTCHA_ENABLED) {
        error_log('reCAPTCHA keys are not configured: verification skipped.');
        return true;
    }
